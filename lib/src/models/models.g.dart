...
_$PosicionConsolidadaRespuestaImpl _$$PosicionConsolidadaRespuestaImplFromJson(
    ...
    _$PosicionConsolidadaRespuestaImpl(
      ...
      minutosDuracionOtp: (json['minutosDuracionOtp'] as num?)?.toInt() ?? 0,
      listaCarrusel: (json['listaCarrusel'] as List<dynamic>?)
              ?.map((e) => ImagenPantalla.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      listaInicial: (json['listaInicial'] as List<dynamic>?)
              ?.map((e) => ImagenPantalla.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
...
Map<String, dynamic> _$$PosicionConsolidadaRespuestaImplToJson(
    ...
    <String, dynamic>{
      ...
      'minutosDuracionOtp': instance.minutosDuracionOtp,
      'listaCarrusel': instance.listaCarrusel,
      'listaInicial': instance.listaInicial,
    };
...
_$ImagenPantallaImpl _$$ImagenPantallaImplFromJson(Map<String, dynamic> json) =>
    _$ImagenPantallaImpl(
      imagen: const Uint8ListConverter().fromJson(json['imagen'] as String?),
    );

Map<String, dynamic> _$$ImagenPantallaImplToJson(
        _$ImagenPantallaImpl instance) =>
    <String, dynamic>{
      'imagen': const Uint8ListConverter().toJson(instance.imagen),
    };
...
_$LoginPrincipalStateImpl _$$LoginPrincipalStateImplFromJson(
        Map<String, dynamic> json) =>
    _$LoginPrincipalStateImpl(
      isLoading: json['isLoading'] as bool? ?? true,
      posicionConsolidada: json['posicionConsolidada'] == null
          ? null
          : PosicionConsolidadaRespuesta.fromJson(
...
Map<String, dynamic> _$$LoginPrincipalStateImplToJson(
        _$LoginPrincipalStateImpl instance) =>
    <String, dynamic>{
      'isLoading': instance.isLoading,
      'posicionConsolidada': instance.posicionConsolidada,
      'errorMessage': instance.errorMessage,
