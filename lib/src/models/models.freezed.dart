...
class _$MovimientoCuentaModelImpl implements _MovimientoCuentaModel {
  ...
  @override
  String toString() {
    return 'MovimientoCuentaModel(fecha: $fecha, transaccion: $transaccion, cheque: $cheque, deposito: $deposito, retiro: $retiro, saldo: $saldo, oficina: $oficina, documento: $documento)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, fecha, transaccion, cheque,
...
class _$EtiquetaValorReciboImpl implements _EtiquetaValorRecibo {
  _$EtiquetaValorReciboImpl({this.etiqueta = '', this.valor = ''});
  ...
  @override
  String toString() {
    return 'EtiquetaValorRecibo(etiqueta: $etiqueta, valor: $valor)';
  }
...
abstract class _EtiquetaValorRecibo implements EtiquetaValorRecibo {
  factory _EtiquetaValorRecibo({final String etiqueta, final String valor}) =
